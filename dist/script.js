        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              elem.forEach(function (box, count) {
                box.checked = false;
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      var statusMessage = document.createElement('div'); // создаем новый элемент верстки
...
var modals = function modals() {
  ...
  var modalTimerId = setTimeout(autoShowModal, 60000);
  ...
  function calclScroll() {
    var div = document.createElement('div'); // Временный блок для вычисления ширины окна без скролла
    // стили
    ...
    var scrollWidth = div.offsetWidth - div.clientWidth; // Вся ширина - ширина без скролла
...
/* harmony default export */ __webpack_exports__["default"] = (modals); // const modals = () => {
...
var tabs = function tabs(_ref) {
  var headerSelector = _ref.headerSelector,
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemaining = function getTimeRemaining(endtime) {
    ...
    var time = Date.parse(endtime) - Date.parse(new Date()),
        ...
        // секунды делим на 60 секунд, остаток = кол-во секунд
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    function updateClock() {
      var time = getTimeRemaining(endtime); // getTimeRemaining возвращает объект
